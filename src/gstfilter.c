...
static void gst_myfilter_set_property(GObject* object, guint property_id,
                                      const GValue* value, GParamSpec* pspec);
static void gst_myfilter_get_property(GObject* object, guint property_id,
...
G_DEFINE_TYPE_WITH_CODE(
    GstMyFilter, gst_myfilter, GST_TYPE_VIDEO_FILTER,
...
static void gst_myfilter_class_init(GstMyFilterClass* klass)
{
    ...
    g_object_class_install_property(
        gobject_class, PROP_METHOD,
        g_param_spec_int("method", "Method", "The method to use", 0, 3, 0,
    ...
    // video_filter_class->transform_frame = GST_DEBUG_FUNCPTR
    // (gst_myfilter_transform_frame);
    video_filter_class->transform_frame_ip =
        GST_DEBUG_FUNCPTR(gst_myfilter_transform_frame_ip);
}

static void gst_myfilter_init(GstMyFilter* cudafilter)
{}

void gst_myfilter_set_property(GObject* object, guint property_id,
                               const GValue* value, GParamSpec* pspec)
{
...
void gst_myfilter_get_property(GObject* object, guint property_id,
                               GValue* value, GParamSpec* pspec)
{
    GstMyFilter* cudafilter = GST_MYFILTER(object);
...
void gst_myfilter_dispose(GObject* object)
{
    GstMyFilter* cudafilter = GST_MYFILTER(object);
...
void gst_myfilter_finalize(GObject* object)
{
    GstMyFilter* cudafilter = GST_MYFILTER(object);
